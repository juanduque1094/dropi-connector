    ...
    if (appKey && appSecret) {
      try {
        ...
        if (items.length > 0) {
          ...
          console.log('✅ Productos generados con datos REALES:', products.length);
        }
